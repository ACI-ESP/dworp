"""
Aurora's 2nd version of the Axelrod model of...
...
This version uses a single stage agent to simplify the agent logic.

Time spent info.
June 27: 10:53am, copied the file from axelrod_aurora_test1.py, done for day.
June 28: 9:48am, modifying
         9:53am, done changing, and updated RegressionTest and test.py
...
class Site(dworp.Agent):
    ...
    # note to aurora: you need to modify state here (not next_state because we are using Agent)
